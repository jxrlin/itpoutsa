...
class ProductSeeder extends Seeder
{
    public function run()
    {
        ...
        // Truncate the table to avoid unique constraint violations
        Product::truncate();
        ...
        Product::insert([
            ...
            [
                ...
                'product_image_url' => null,
                'product_segment' => 'The black Creative Pebble USB 2.0 Desktop Speakers from Creative Labs are designed to be compact and modern, with an orb shape thats inspired by the pebbles found in Japanese rock gardens. Their compact 4.4" width and 45° drivers deliver an elevated sound stage for personalized listening without sacrificing much desk space. Simply connect the USB-powered speakers to your computer and enjoy the enhanced audio experience.',
            ...
            [
                ...
                'product_image_url' => null,
                'product_segment' => 'Support your computer, mobile, and smart devices with fast and reliable wireless network connections using the RT6600 AX6600 Wireless Tri-Band 2.5G / Gigabit Router from Synology. Powered by a 1.8 GHz processor with 1GB of memory and six external antennas, this router provides a stable and secure connection for your home or office network.',
